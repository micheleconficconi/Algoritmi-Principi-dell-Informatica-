//differenze dalla precedente: rimuovo i nomi dagli ingredienti nei lotti del magazzino, e anche i nomi negli heap
// e li sostituisco con un numero unico che li identifica, per fare confronti tra numeri e non stringhe
